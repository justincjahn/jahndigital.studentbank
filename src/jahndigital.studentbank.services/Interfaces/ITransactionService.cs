...
namespace jahndigital.studentbank.services.Interfaces
{
    ...
    public interface ITransactionService
    {
        ...
        Task<(Transaction, Transaction)> TransferAsync(
            long sourceShareId,
        ...
        Task<StudentPurchase> PurchaseAsync(PurchaseRequest input);
        ...
        Task<StudentStock> PurchaseStockAsync(PurchaseStockRequest input);

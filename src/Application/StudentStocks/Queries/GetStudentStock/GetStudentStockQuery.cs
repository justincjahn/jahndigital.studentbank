...
namespace JahnDigital.StudentBank.Application.StudentStocks.Queries.GetStudentStock;

public record GetStudentStockQuery(long Id) : IRequest<IQueryable<StudentStock>>;
...
public class GetStudentStockQueryHandler : IRequestHandler<GetStudentStockQuery, IQueryable<StudentStock>>
{
    ...
    {
        return Task.FromResult(_context.StudentStocks.Where(x => x.Id == request.Id));
    }
}
